...
const getAllCourses = async (req, res) => {
  try {
    ...
    const courses = await Course.getCoursesWithPrivilege(user._id,user.university)
   // const courses = await Course.getCoursesWithPrivilege(user.university)


   //let courses = await Course.find({ university: user.university });
...
const createCourse = async (req, res) => {
  ...
  try {
    ...
    //course.enroll(user.university, user.role)
    ...
    const result = await Course.getCoursesWithPrivilege(user._id, user.university)
    //const result = await Course.find({ university: user.university });
...
const updateCourse = async (req, res) => {
  ...
  const { name, description, image, status, backgroundColor,university } = req.body
...
const enroll = async (req, res) => {
  ...
  try {
    ...
    //const user = await User.find(university).orFail()
    
    let course = await Course.findById(courseId).orFail()
    
    course = course.enroll(user._id, user.role)
    //course = course.enroll(user.university, user.role)
   ...
   const result = await Course.getCoursesWithPrivilege(userId,user.university)
   //const result = await Course.find({ university: user.university });
